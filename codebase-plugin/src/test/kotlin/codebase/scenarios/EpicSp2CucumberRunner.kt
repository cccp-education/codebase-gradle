...
@ConfigurationParameter(
    ...
    value = "pretty, html:build/reports/cucumber-epic-sp2.html, json:build/reports/cucumber-epic-sp2.json"
)
@ConfigurationParameter(key = FEATURES_PROPERTY_NAME, value = "src/test/features")
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@epic_sp_2")
class EpicSp2CucumberRunner
