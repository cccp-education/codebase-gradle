...
@ConfigurationParameter(
    ...
    value = "pretty, html:build/reports/cucumber-epic-x5.html, json:build/reports/cucumber-epic-x5.json"
)
@ConfigurationParameter(key = FEATURES_PROPERTY_NAME, value = "src/test/features")
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@epic_x_5")
class EpicX5CucumberRunner
