...
@ConfigurationParameter(
    ...
    value = "pretty, html:build/reports/cucumber-epic-x4.html, json:build/reports/cucumber-epic-x4.json"
)
@ConfigurationParameter(key = FEATURES_PROPERTY_NAME, value = "src/test/features")
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@epic_x_4")
class EpicX4CucumberRunner
