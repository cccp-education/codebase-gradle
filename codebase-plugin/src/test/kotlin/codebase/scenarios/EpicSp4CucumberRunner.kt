...
@ConfigurationParameter(
    ...
    value = "pretty, html:build/reports/cucumber-epic-sp4.html, json:build/reports/cucumber-epic-sp4.json"
)
@ConfigurationParameter(key = FEATURES_PROPERTY_NAME, value = "src/test/features")
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@epic_sp_4")
class EpicSp4CucumberRunner
