...
@ConfigurationParameter(
    ...
    value = "pretty, html:build/reports/cucumber-epic-sp5.html, json:build/reports/cucumber-epic-sp5.json"
)
@ConfigurationParameter(key = FEATURES_PROPERTY_NAME, value = "src/test/features")
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@epic_sp_5")
class EpicSp5CucumberRunner
