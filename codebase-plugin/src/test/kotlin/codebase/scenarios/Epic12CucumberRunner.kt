...
@ConfigurationParameter(
    ...
    value = "pretty, html:build/reports/cucumber-epic-12.html, json:build/reports/cucumber-epic-12.json"
)
@ConfigurationParameter(key = FEATURES_PROPERTY_NAME, value = "src/test/features")
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@epic12")
class Epic12CucumberRunner
